<?php 
    ...
    if( isset($_POST['submit']) ) {
        ...
        $itm->show_in_menu = $show_in_menu;
        $controllerCategory->insertCategory($itm);
                                ...
                                <div class="col-lg-12">
                                    <form role="form" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Category Name" name="category" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="1" name="show_in_menu">Show In Menu
                                                </label>
                                            </div>
                                        </div>
