<?php 
    ...
    $couponsFeatured = $controllerCoupon->getCouponsFeatured();
    $couponsCount = count($coupons);
    $couponsFeaturedCount = count($couponsFeatured);
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="home.php" class="active"><i class="fa fa-dashboard fa-fw"></i> Home</a>
                        </li>
                        <li>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $couponsCount; ?></div>
                                    <div>Coupons</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $couponsFeaturedCount; ?></div>
                                    <div>Featured</div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-tags fa-fw"></i> Featured Coupons
                        </div>
                        <!-- /.panel-heading -->
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <?php 
                                                    $ind = 1;
                                                    foreach ($couponsFeatured as $coupon) {
